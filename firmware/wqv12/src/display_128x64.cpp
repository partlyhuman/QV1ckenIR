...
void showIdleScreen() {
    ...
    static const unsigned char PROGMEM image_IRIcon_bits[] = {
    ...
    // IRIcon
    display.drawBitmap(71, 35, image_IRIcon_bits, 24, 11, 1);
    ...
    // >
    display.drawBitmap(44, 23, image___1_bits, 3, 5, 1);

    // >
    display.drawBitmap(74, 23, image___1_bits, 3, 5, 1);

    // Text1
    display.setCursor(22, 15);
    display.print("WQV-1 or WQV-2:");
